...
/*
This is used to hold the subnets that are desired to be added to a virtualNetwork.
*/
type Subnet struct {
...
/*
This is used to parse the subnets that already exist in a Azure Virtual Network.
*/
type SnetSubnet struct {
	AddressPrefix string `json:"addressPrefix"`
}

/*
This is used to parse the addressPrefixes of a Azure Virtual Network
*/
...
/*
This is used to store the results and is later marchalled into a pretty json string
that will be send to stdout.
*/
type Output struct {
...
/*
This is used to parse a Azure Virtual Network json document
*/
type VirtualNetwork struct {
	Space          SpaceCollection  `json:"addressSpace"`
	Subnets        []SnetSubnet     `json:"subnets"`
...
func (d *VirtualNetwork) CalculateSubnets() (Output, error) {
	...
	for i := range d.Subnets {
		var s addressSpace
		address, cidr := splitAddressNetmask(d.Subnets[i].AddressPrefix)
		s.set(address, cidr)
